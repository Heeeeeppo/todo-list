...
function App() {
    ...
    //     const id = curElement.parentNode.id;
    //     let completed = true;
    //     const text = curElement.innerText;
    //     const taskToUpdate = todos.find((todo) => todo._id === id);
    //     const updatedTask = { ...taskToUpdate, completed: !taskToUpdate.completed };
    ...
    //         });
    //         // const data = await response.json();
    //         // let toggledTask = todos.find(todo => todo._id === id);
    //         // toggledTask.completed = data.completed;
    //         // setTodos(todos);
    //         // // console.log(todos)
    //         // await fetchTask()
    //         // console.log(todos)
                ...
                {todos.map((todo) => {
                    return (
                        <div className="todo" key={todo._id} id={todo._id}>
                            {todo.completed ? 
                                <li className="checked" onClick={toggleComplete}>{todo.text}</li> : <li onClick={toggleComplete}>{todo.text}</li>}
